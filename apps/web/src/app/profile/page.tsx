...
const STATS = [
  { label: 'Games Played', value: '42', color: '#e8e0d0' },
  { label: 'Wins', value: '18', color: '#22c55e' },
  { label: 'Losses', value: '16', color: '#ef4444' },
  { label: 'Draws', value: '8', color: '#9aa5b4' },
]
              ...
              >
                ...
                <div
                  style={{
                    ...
                    height: '8px',
                    borderRadius: '50%',
                    background: f.online ? '#22c55e' : '#374151',
                    marginLeft: 'auto',
                    marginRight: '0.75rem',
                    flexShrink: 0,
                  }}
